...
export default {
  data: () => {
    return {
      webTitle: "Nazafat Hussain - Software Developer",
    };
  },
  setup() {
    useMeta({
      title: "Nazafat Hussain - Software Developer",
      ...
      og: {
        ...
        image:
          "https://github.com/Nazafat7" +
          require(`@/assets/images/preview.png`),
        site_name: "Nazafat Hussain - Software Developer",
      },
      meta: [
        {
          name: "keywords",

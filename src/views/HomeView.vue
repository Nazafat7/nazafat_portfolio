<template>
  <!-- Menu -->
  <MenuVue :links="links">>nazafat#~/<span class="prim">h</span></MenuVue>
  <HeroSection id="hero" pic="header.png">
    <template v-slot:welcome>Welcome!</template>
    My name is <b>Nazafat Hussain</b> and I'm a
    <hi-word>software developer</hi-word>. My passion is building
    <hi-word>web applications</hi-word> and
    <hi-word>designing websites</hi-word> I specialize in crafting
    <hi-word>APIs</hi-word> that power applications, ensuring seamless
    communication between the frontend and backend
    <template v-slot:buttons>
      <simple-button
        class="btn-primary text-white"
        url="https://linkedin.com/in/contactnazafathussain"
        icon="fab linkedin-in"
        >Hire me!</simple-button
      >
      <simple-button
        class="btn-outline-secondary"
        url="mailto:nazafat9@gmail.com"
    ...
    return {
      ...
      socials: [
        ...
        },
        {
          id: 2,
          icon: "fab github",
          url: "https://github.com/Nazafat7",
        },
      ],
      copyright: "2023 Nazafat Hussain",
    };
  },
  components: {
    MenuVue,
